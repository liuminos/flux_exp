...
#noise
noise_level = 1e-3
noise = np.zeros([4,101]) ### need to change
noise += noise_level
noise[1] /= 5. 
noise[2] /= 5. 
noise[3] /= 5. 
...
to_fit = stokes[:,:,:,:101] ### stokes to fit
#me inversion
...
hdu3 = fits.ImageHDU(chi2)
hdulist = fits.HDUList([hdu1,hdu2,hdu3])
hdulist.writeto(filepath[:-4]+'_inverted_6173.fits',overwrite=True)